...
var antecedentsTotalForms = document.querySelector('.antecedents_management_form > #antecedent_info-TOTAL_FORMS')
    ...
    extraInfo.addEventListener('click', (e) =>{
        ...
        if (e.target.classList.contains('add-antecedent-form')){
           /* This event will be fired every time the target contains the add-antecedent-form, this event will add another
            ...
            let antecedentsTotalForms = document.querySelector('.antecedents_management_form #id_antecedent-info-TOTAL_FORMS')
            ...
            for (let i = 0; i<clonedNode.childNodes.length; i++){
                if (clonedNode.childNodes[i].firstChild){
                    if (clonedNode.childNodes[i].childNodes[0].nodeName === 'INPUT' && clonedNode.childNodes[i].childNodes[0].type === 'text'){
                        clonedNode.childNodes[i].childNodes[0].name = 'antecedent-info-' + formAmount.length + '-antecedent'
                        clonedNode.childNodes[i].childNodes[0].id = 'id_antecedent-info-' + formAmount.length + '-antecedent'
                    }else if (clonedNode.childNodes[i].childNodes[0].nodeName === 'TEXTAREA'){
                        clonedNode.childNodes[i].childNodes[0].name = 'antecedent-info-' + formAmount.length + '-info'
                        clonedNode.childNodes[i].childNodes[0].id = 'id_antecedent-info-' + formAmount.length + '-info'
                    }else if (clonedNode.childNodes[i].childNodes[0].nodeName === 'INPUT' && clonedNode.childNodes[i].childNodes[0].type === 'checkbox'){
                        clonedNode.childNodes[i].childNodes[0].name = 'antecedent-info-' + formAmount.length + '-DELETE'
                        clonedNode.childNodes[i].childNodes[0].id = 'id_antecedent-info-' + formAmount.length + '-DELETE'
                    }
                }
            }
