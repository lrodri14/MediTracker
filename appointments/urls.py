...
urlpatterns = [
    ...
    path('add_vaccination_record', add_vaccination_record, name='add_vaccination_record'),
    path('update_vaccination_record/<int:pk>', update_vaccination_record, name='update_vaccination_record'),
    path('vacciantion_record_details/<int:pk>', vaccination_record_details, name='vaccination_record_details'),
    path('delete_vaccination_record/<int:pk>', delete_vaccination_record, name='delete_vaccination_record'),
    path('appoint_surgery', appoint_surgery, name='appoint_surgery'),
